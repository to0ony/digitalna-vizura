...
function Home() {
  ...
  const navItems = [
    { label: "Početna", sectionId: null, isLink: true, to: "/" },
    { label: "Usluge", sectionId: "services" },
    { label: "Radovi", sectionId: null, isLink: true, to: "/radovi" },
      ...
      <section className="relative h-[70vh] flex items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-sm rounded-xl p-10 max-w-3xl">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">
            Izrada web rješenja i brending koji ostavlja{" "}
            <span style={{ fontFamily: "'IM Fell French Canon', serif" }}>
              dojam
            </span>
            .
          </h1>
